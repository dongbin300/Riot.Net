...
namespace Val.Net.Clients.ValApis
{
    public class ValMatchApi : ValApiClient
    {
        ...
        public async Task<ValMatch> GetMatchByMatchIdAsync(string matchId)
        {
        ...
        public async Task<ValMatchlist> GetMatchlistByPuuIdAsync(string puuId)
        {
        ...
        public async Task<ValRecentMatches> GetRecentMatchesAsync(ValQueue queue)
        {
